...
public enum DWARFOpcode: CaseIterable, Sendable {
    /// DW_OP_addr
    case addr
    /// DW_OP_deref
    case deref
...
extension DWARFOpcode: RawRepresentable {
    ...
    public init?(rawValue: RawValue) {
        ...
        case numericCast(DW_OP_implicit_pointer): self = .implicit_pointer
        case numericCast(DW_OP_addrx): self = .addrx
        case numericCast(DW_OP_constx): self = .constx
        case numericCast(DW_OP_entry_value): self = .entry_value
        case numericCast(DW_OP_const_type): self = .const_type
        case numericCast(DW_OP_regval_type): self = .regval_type
        case numericCast(DW_OP_deref_type): self = .deref_type
        case numericCast(DW_OP_xderef_type): self = .xderef_type
        case numericCast(DW_OP_convert): self = .convert
        case numericCast(DW_OP_reinterpret): self = .reinterpret
...
//        case numericCast(DW_OP_HP_tls): self = .hp_tls
    ...
    public var rawValue: RawValue {
        ...
        case .implicit_pointer: numericCast(DW_OP_implicit_pointer)
        case .addrx: numericCast(DW_OP_addrx)
        case .constx: numericCast(DW_OP_constx)
        case .entry_value: numericCast(DW_OP_entry_value)
        case .const_type: numericCast(DW_OP_const_type)
        case .regval_type: numericCast(DW_OP_regval_type)
        case .deref_type: numericCast(DW_OP_deref_type)
        case .xderef_type: numericCast(DW_OP_xderef_type)
        case .convert: numericCast(DW_OP_convert)
        case .reinterpret: numericCast(DW_OP_reinterpret)
...
extension DWARFOpcode: CustomStringConvertible {
    public var description: String {
        ...
        case .implicit_pointer: "DW_OP_implicit_pointer"
        case .addrx: "DW_OP_addrx"
        case .constx: "DW_OP_constx"
        case .entry_value: "DW_OP_entry_value"
        case .const_type: "DW_OP_const_type"
        case .regval_type: "DW_OP_regval_type"
        case .deref_type: "DW_OP_deref_type"
        case .xderef_type: "DW_OP_xderef_type"
        case .convert: "DW_OP_convert"
        case .reinterpret: "DW_OP_reinterpret"
